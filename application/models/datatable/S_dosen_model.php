...
class S_dosen_model extends CI_Model
{
    // beres
    ...
    // datatable
    var $order = ['nip', 'nip', 'nama', 'email', 'kodeprodi', 'bidminatid', 'nip'];
    // beres
    private function _get_data_query()
    {
        ...
        if ($this->input->post("bidangminat_filter")) {
            $this->db->where('bidminatid', $this->input->post("bidangminat_filter"));
        }
