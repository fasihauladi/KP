...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('superadmin/karya-penelitian/edit/' . $id) ?>"> Edit</a></li>
        </ol>
    </section>
    <!-- main content -->
        ...
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title text-capitalize">
                    Edit Karya Penelitian
                </h3>
            </div>
            <div class="box-body">
                <form class="form-row" id="formEditKaryaPenelitian" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-12" id="inputan_katpenelitianid">
                        ...
                        <div>
                            <select id="katpenelitianid" name="katpenelitianid" class="form-control bg-info text-light">
                ...
                <div id="btnEdit">
                    <button type="button" class="btn btn-primary" name="tombolEdit" onclick="editKaryaPenelitianProcess()">Edit</button>
                </div>
            </div>
        </div>
    </section>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: 'GET',
            url: '<?= base_url('karyapenelitian/getkaryapenelitianbyid/'); ?>' + $('#id').val(),
            dataType: 'JSON',
            success: function(response) {
                ...
                if (response.foto) {
                    $('#tempatFoto').html('<img height="200" width="200" class="rounded-circle" src="<?= base_url(); ?>assets/gambarDB/karya/penelitian/' + response.foto + '" alt="Foto" id="lihatFoto" name="lihatFoto">');
                }
    ...
    function editKaryaPenelitianProcess() {
        ckeditor();
        $('[name="tombolEdit"]').attr("disabled", true);
        $('[name="tombolEdit"]').text("loading..");
        let formData = new FormData($('#formEditKaryaPenelitian').get(0));
        formData.append("csrf_test_name", csrfHash);
        $.ajax({
            type: "POST",
            url: "<?= base_url(); ?>karyapenelitian/editDataProcess",
            data: formData,
            processData: false,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                ...
                if (data.message == 'sukses') {
                    Swal.fire('Data Berhasil Diedit', '', 'success').then(function() {
                        window.location = "<?= base_url(); ?>superadmin/karya-penelitian";
                    });
                    ...
                    $('.katpenelitianid-error').html(data.katpenelitianid_error);
