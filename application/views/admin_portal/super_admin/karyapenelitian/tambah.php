...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('superadmin/karya-penelitian/tambah') ?>"> Tambah</a></li>
        </ol>
    </section>
    <!-- main content -->
        ...
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title text-capitalize">
                    Tambah Karya Penelitian
                </h3>
            </div>
            <div class="box-body">
                <form class="form-row" id="formKaryaPenelitian" enctype="multipart/form-data">
                    <!-- kodeprodi -->
                ...
                <div id="btnTambah">
                    <button type="button" class="btn btn-primary" name="tombolTambah" onclick="tambahKaryaPenelitianProcess()">Tambah</button>
                </div>
            </div>
        </div>
    </section>
...
<script>
    ...
    function tambahKaryaPenelitianProcess() {
        ckeditor();
        $('[name="tombolTambah"]').attr("disabled", true);
        $('[name="tombolTambah"]').text("loading..");
        let formData = new FormData($('#formKaryaPenelitian').get(0));
        formData.append("csrf_test_name", csrfHash);
        $.ajax({
            type: "POST",
            url: "<?= base_url(); ?>karyapenelitian/tambahDataProcess",
            data: formData,
            processData: false,
            contentType: false,
            cache: false,
