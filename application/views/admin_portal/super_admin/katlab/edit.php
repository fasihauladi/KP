...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('superadmin/kategori-laboratorium/edit/' . $id) ?>"> Edit</a></li>
        </ol>
    </section>
    <!-- main content -->
        ...
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title text-capitalize">
                    Edit Kategori Laboratorium
                </h3>
            </div>
            <div class="box-body">
                <form class="form-row" id="formEditKategoriLaboratorium" enctype="multipart/form-data">
                ...
                <div id="btnEdit">
                    <button type="button" class="btn btn-primary" name="tombolEdit" onclick="editKategoriLaboratoriumProcess()">Edit</button>
                </div>
            </div>
        </div>
    </section>
...
<script>
    ...
    $(document).ready(function() {
        $.ajax({
            type: 'GET',
            url: '<?= base_url('katlab/getkatlabbyid/'); ?>' + $('#id').val(),
            dataType: 'JSON',
    ...
    function editKategoriLaboratoriumProcess() {
        $('[name="tombolEdit"]').attr("disabled", true);
        $('[name="tombolEdit"]').text("loading..");
        $.ajax({
            type: "POST",
            url: "<?= base_url(); ?>katlab/editDataProcess",
            data: $("#formEditKategoriLaboratorium").serialize() + "&csrf_test_name=" + csrfHash,
