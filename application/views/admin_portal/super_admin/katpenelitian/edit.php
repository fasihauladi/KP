...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('superadmin/kategori-penelitian/edit/' . $id) ?>"> Edit</a></li>
        </ol>
    </section>
    <!-- main content -->
    <section class="content">
        <div class="box box-success">
            ...
            <div class="box-body">
                <form class="form-row" id="formEditKategoriPenelitian" enctype="multipart/form-data">
                ...
                <div id="btnEdit">
                    <button type="button" class="btn btn-primary" name="tombolEdit" onclick="editKategoriPenelitianProcess()">Edit</button>
                </div>
            </div>
        </div>
    </section>
...
<script>
    ...
    $(document).ready(function() {
        $.ajax({
            type: 'GET',
            url: '<?= base_url('katpenelitian/getkatpenelitianbyid/'); ?>' + $('#id').val(),
            dataType: 'JSON',
    ...
    function editKategoriPenelitianProcess() {
        $('[name="tombolEdit"]').attr("disabled", true);
        $('[name="tombolEdit"]').text("loading..");
        $.ajax({
            type: "POST",
            url: "<?= base_url(); ?>katpenelitian/editDataProcess",
            data: $("#formEditKategoriPenelitian").serialize() + "&csrf_test_name=" + csrfHash,
