...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('superadmin/pengurus/edit/' . $id) ?>"> Edit</a></li>
        </ol>
    </section>
    <!-- main content -->
    <section class="content">
        <div class="box box-success">
            ...
            <div class="box-body">
                <form class="form-row" id="formEditPengurus" enctype="multipart/form-data">
...
<script>
    ...
    $(document).ready(function() {
        $.ajax({
            type: 'GET',
            url: '<?= base_url('pengurus/getpengurusbyid/'); ?>' + $('#id').val(),
            dataType: 'JSON',
    ...
    function editProdiProcess() {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url(); ?>pengurus/editDataProcess",
            data: $("#formEditPengurus").serialize() + "&csrf_test_name=" + csrfHash,
