...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('superadmin/seputar-ukm/tambah') ?>"> Tambah</a></li>
        </ol>
    </section>
    <!-- main content -->
    <section class="content">
        <div class="box box-success">
            ...
            <div class="box-body">
                <form class="form-row" id="formUKMBerita" enctype="multipart/form-data">
                    <!-- kodeprodi -->
...
<script>
    ...
    function tambahLabBeritaProcess() {
        ...
        let formData = new FormData($('#formUKMBerita').get(0));
        formData.append("csrf_test_name", csrfHash);
        $.ajax({
            type: "POST",
            url: "<?= base_url(); ?>ukmberita/tambahDataProcess",
            data: formData,
            processData: false,
            contentType: false,
            cache: false,
